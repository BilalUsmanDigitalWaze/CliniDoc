...
router.post(
  ...
  body("referral_id")
    ...
    .isEmpty()
    .isInt()
    .withMessage("Please enter Refrrel Id"),
  ...
  body("dob")
    ...
    .isEmpty()
    .isDate()
    .withMessage("Please enter you date of birth"),
  body("legal_gardian")
    .not()
    .isEmpty()
    .isString()
  ...
  body("marital_status")
    .isString()
    .withMessage("Please enter your marital status correctly"),
  body("race").isString().withMessage("Please enter race "),
  body("reason_for_contact")
    .not()
    .isEmpty()
    .isString()
    .withMessage("Please enter valid reason for contact"),
  body("insurance_name")
    .isString()
    .withMessage("Please enter valid insurance name"),
  body("insurance_member_id")
    .isInt()
    .withMessage("Please enter valid Insurance  Id"),
  ...
  body("relationship_to_insured")
    .isString()
    .withMessage("Enter valid relationship to insured"),
  ...
  body("insurance_phone")
    .isMobilePhone()
    .withMessage("enter valid isurance phone"),
  body("ssn").isInt().withMessage("Enter valid ssn"),
  body("emergency_name")
    .not()
    .isEmpty()
    .isString()
    .withMessage("Enter valid Emergency name"),
  body("emergency_relationship")
    .not()
    .isEmpty()
    .isString()
    .withMessage("enter valid relationship"),
  body("emergency_phone")
    .not()
    .isEmpty()
    .isMobilePhone()
    .withMessage("enter valid emergency phone"),
